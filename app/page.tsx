...
import WellMindFloatingWidget from "./components/WellMindFloatingWidget";
...
export default function Home() {
  ...
  return (
    <>
      <section className="pt-28 md:pt-32">
        <div className="max-w-xl">
          ...
          <p className="text-lg text-slate-500 max-w-2xl leading-relaxed mb-8">
            Empower HR & team leads to identify burnout risk early using AI
            heuristics, ledger-backed audit trails, and orchestration hooks.
            Actionable insights. Zero friction.
          </p>
          ...
          <div className="flex gap-4">
            ...
            <Link href="/hr" className="btn btn-care">
              HR Dashboard
            </Link>
          </div>
        </div>
      ...
      <WellMindFloatingWidget open={openChat} onClose={() => setOpenChat(false)} />
    </>
  );
}
